class Config {
  ...
  void deserialize(String[] contents) throws Exception {
    ...
    for (String line : contents) {
      ...
      switch (components[0]) {
      case "player.hp": 
        hp = Float.parseFloat(components[1]); 
        break;
      case "player.money": 
        money = Integer.parseInt(components[1]); 
        break;
      case "player.eco": 
        eco = Integer.parseInt(components[1]); 
        break;
      case "player.width": 
        playerWidth = Float.parseFloat(components[1]); 
        break;
      case "player.height": 
        playerHeight = Float.parseFloat(components[1]); 
        break;


      case "map.base_height": 
        baseHeight = Float.parseFloat(components[1]); 
        break;
      case "map.amplitude": 
        amplitude = Float.parseFloat(components[1]); 
        break;
      case "map.scale": 
        scale = Float.parseFloat(components[1]); 
        break;
      case "map.noise_detail": 
        noiseDetail = Integer.parseInt(components[1]); 
        break;

      case "map.floating.scale": 
        floatingScale = Float.parseFloat(components[1]); 
        break;
      case "map.floating.threshold": 
        floatingThreshold = Float.parseFloat(components[1]); 
        break;

      case "map.turf.propability": 
        turfPropability = Float.parseFloat(components[1]); 
        break;
      case "map.turf.scale": 
        turfScale = Float.parseFloat(components[1]); 
        break;


      case "game.price_factor": 
        priceFactor = Float.parseFloat(components[1]); 
        break;
      case "game.gravity": 
        gravity = Float.parseFloat(components[1]); 
        break;
      case "game.air_friction": 
        airFriction = Float.parseFloat(components[1]); 
        break;
      case "game.ground_friction": 
        groundFriction = Float.parseFloat(components[1]); 
        break;
      case "game.ground_gravity_resistance": 
        groundGravityResistance = Float.parseFloat(components[1]); 
        break;
      case "game.show_lines": 
        showLines = decodeBool(components[1]); 
        break;
      case "game.wall_bounce": 
        wallBounce = Float.parseFloat(components[1]); 
        break;
      case "game.friendly_attack_noclip": 
        friendlyAttackNoclip = decodeBool(components[1]); 
        break;
      case "game.friendly_turf_noclip": 
        friendlyTurfNoclip = decodeBool(components[1]); 
        break;

      case "game.shot.power": 
        shotPower = Float.parseFloat(components[1]); 
        break;
      case "game.shot.noise": 
        shotNoise = Float.parseFloat(components[1]); 
        break;
      case "game.shot.count": 
        shotCount = Integer.parseInt(components[1]); 
        break;
      case "game.shot.stroke": 
        shotStroke = Float.parseFloat(components[1]); 
        break;
      case "game.shot.childstroke": 
        shotChildstroke = Float.parseFloat(components[1]); 
        break;

      case "game.death.power": 
        deathPower = Float.parseFloat(components[1]); 
        break;
      case "game.death.noise": 
        deathNoise = Float.parseFloat(components[1]); 
        break;
      case "game.death.count": 
        deathCount = Integer.parseInt(components[1]); 
        break;
      case "game.death.stroke": 
        deathStroke = Float.parseFloat(components[1]); 
        break;
      case "game.death.type": 
        deathType = Integer.parseInt(components[1]); 
        break;


      case "lobby.team_count": 
        teamCount = Integer.parseInt(components[1]); 
        break;
      case "lobby.players_per_team": 
        playersPerTeam = Integer.parseInt(components[1]); 
        break;
      ...
      case "controls.key0": 
        ...
        break;
      case "controls.key1": 
        key1 = decodeChar(components[1]); 
        break;
      case "controls.key2": 
        key2 = decodeChar(components[1]); 
        break;
      case "controls.key3": 
        key3 = decodeChar(components[1]); 
        break;
      case "controls.key4": 
        key4 = decodeChar(components[1]); 
        break;
      case "controls.confirm": 
        confirm = decodeChar(components[1]); 
        break;
      case "controls.confirm_alt": 
        confirmAlt = decodeChar(components[1]); 
        break;
      case "controls.input_scale": 
